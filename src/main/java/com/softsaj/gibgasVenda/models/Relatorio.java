...
public class Relatorio {
    ...
    private String emitenteInscricaoEstadualSubtritutario;
    private String emitenteEndereco;       
    private String emitenteEnderecoNro;       
    ...
    */
    ...
    public void setDestinatarioCnpj(String destinatarioCnoj) {
        this.destinatarioCnpj = destinatarioCnoj;
    }
    ...
    public String getEmitenteInscricaoEstadualSubtritutario() {
        return emitenteInscricaoEstadualSubtritutario;
    }

    public void setEmitenteInscricaoEstadualSubtritutario(String emitenteInscricaoEstadualSubtritutario) {
        this.emitenteInscricaoEstadualSubtritutario = emitenteInscricaoEstadualSubtritutario;
    }
    ...
    public String getEmitenteEnderecoNro() {
        return emitenteEnderecoNro;
    }

    public void setEmitenteEnderecoNro(String emitenteEnderecoNro) {
        this.emitenteEnderecoNro = emitenteEnderecoNro;
    }
    ...
    public String getDestinatarioEnderecoNro() {
        return destinatarioEnderecoNro;
    }

    public void setDestinatarioEnderecoNro(String destinatarioEnderecoNro) {
        this.destinatarioEnderecoNro = destinatarioEnderecoNro;
    }
    ...
    public String getDetCount() {
        return detCount;
    }

    public void setDetCount(String detCount) {
